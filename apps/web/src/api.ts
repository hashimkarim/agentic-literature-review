...
export const api = {
  ...
  writingCandidates: (projectId: string, id: string) => request<WritingCandidateSummary[]>(`/api/projects/${encodeURIComponent(projectId)}/manuscripts/${encodeURIComponent(id)}/candidates`),
  writingCandidate: (projectId: string, id: string, batchId: string) => request<WritingCandidateBatch>(`/api/projects/${encodeURIComponent(projectId)}/manuscripts/${encodeURIComponent(id)}/candidates/${encodeURIComponent(batchId)}`),
  createWritingCandidates: (projectId: string, id: string, body: CreateWritingCandidates) => request<WritingCandidateBatch>(`/api/projects/${encodeURIComponent(projectId)}/manuscripts/${encodeURIComponent(id)}/candidates`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }),
  cancelWritingCandidates: (projectId: string, id: string, batchId: string) => request<WritingCandidateBatch>(`/api/projects/${encodeURIComponent(projectId)}/manuscripts/${encodeURIComponent(id)}/candidates/${encodeURIComponent(batchId)}/cancel`, { method: "POST" }),
  acceptWritingCandidate: (projectId: string, id: string, batchId: string, candidateId: string, expectedRevision: string) => request<ManuscriptFile>(`/api/projects/${encodeURIComponent(projectId)}/manuscripts/${encodeURIComponent(id)}/candidates/${encodeURIComponent(batchId)}/accept`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ candidateId, expectedRevision }) }),
