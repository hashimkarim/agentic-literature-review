...
Updated: 2026-09-21. Delivery order: [roadmap](ROADMAP.md).
...
| WRITE-03 | Citation-needed assistant: Planned | P1 | Mark unsupported draft claims, propose selected-library evidence and validate support before adding a citekey; external discovery is a separate explicit action. | C32, C33 |
| WRITE-04 | Outlines and literature-review drafts: Partial | P1 | Extend accepted-comparison synthesis into an editable outline and cited sections; show source scope and require accepting generated changes. | C03, C31, C37 |
| WRITE-05 | Bounded writing commands: Planned | P2 | Expand/shorten/clarify/paraphrase/translate selected text with diffs; retain citations and flag changes that alter claim strength or meaning. | C23, C32, C34 |
