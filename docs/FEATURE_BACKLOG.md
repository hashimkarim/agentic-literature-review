...
| WRITE-18 | Text history beyond Git: Partial backend | P1 | Automatic saved versions, named checkpoints, exact diffs and conflict-checked restore that retains replaced text; per-file storage/API implemented, UI and grouped manuscript versions remain open. | Core |
